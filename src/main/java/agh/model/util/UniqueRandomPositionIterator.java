...
public class UniqueRandomPositionIterator implements Iterator<Vector2d> {
    ...
    public agh.model.Vector2d next() {
        ...
        agh.model.Vector2d randomPosition = positions.get(swapIndex);
        agh.model.Vector2d temp = positions.get(currentPosition);
